          ...
          {selectedInstructorInfo === "EMI" && (
            <div className="space-y-4">
              <div className="bg-gradient-to-br from-background to-background/80 border border-primary/40 rounded-lg p-6">
                <h3 className="text-xl font-pixel text-pixel mb-4">EMI - CEO и идейный вдохновитель</h3>
                <p className="text-muted-foreground leading-relaxed">
                  EMILY - CEO и идейный вдохновитель сервиса Gotham's Top Model. Tattoo - artist, model and blogger. 
                  Собрание интервью из туров таких локаций как Seoul / Hong-Kong / Bangkok & etc. 
                  Опыт &gt;5 лет. Индивидуальные эскизы, дизайн тела и эффективнейшее обучение для игроков всех уровней!
                </p>
              </div>
            </div>
          )}
