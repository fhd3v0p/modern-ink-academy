  ...
  const mainCourses = [
    {
      ...
      features: [
        ...
        "Основы Практики на искусственной коже",
        "База про создание эскизов",
        "База про развитие соцсетей",
    ...
    },
    {
      ...
      features: [
        ...
        "Работа с кожей и пигментами",
        "Безопасность и обработка оборудования",
        "Расширенная практика на искусственной коже",
        "Отдельные блоки по грей-вошу",
        "Цветным татуировкам",
        "Работе с плотными закрасами",
        "Работе с масштабом в черной графике",
        "Работе с випшейдингом",
        "Расширенный блок про создание эскизов",
        "Расширенный блок про развитие соцсетей и их ведение",
        "Наставничество после курса"
      ],
      bonus: "Поддержка 24/7"
    },
    {
